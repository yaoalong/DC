package lab.mars.dc.reflection;

import com.esotericsoftware.kryo.Kryo;
import com.esotericsoftware.kryo.io.Input;
import com.esotericsoftware.kryo.io.Output;
import com.google.common.collect.Sets;
import lab.mars.dc.reflection.KryoConfiguration.ClassAccess;
...
public class ResourceReflection {
    ...
    public static <R> R partialRetrieve(R source, R retrieveRef) {
        KryoConfiguration.ClassAccess clzAccess = KryoConfiguration.get(source.getClass());
        if (clzAccess == null)
            return null;
    ...
    public static <R> R deserialize(Class<R> cls, Map<String, Object> result) {
        KryoConfiguration.ClassAccess clzAccess = KryoConfiguration.get(cls);
        if (clzAccess == null)
            return null;
        R instance = (R) clzAccess.constructorAccess.newInstance();
        if (result != null)
